...
const { findProduct,createProduct,findAllProduct,updateProduct,deleteProduct ,productReview } = require('../controller/productController')
...
router.route("/products").get(isAuthenticated,authorizeRoles,findAllProduct) //authorizeRoles
